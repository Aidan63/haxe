...
let create_continuation_api base_continuation_class immediate_suspension_result_class suspension_state immediate_result immediate_error state result error completion context goto_label recursing = {
